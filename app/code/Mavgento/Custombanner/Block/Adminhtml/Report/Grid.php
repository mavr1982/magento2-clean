 ...
 * @license     
 */
namespace Mavgento\Custombanner\Block\Adminhtml\Report;
use Mavgento\Custombanner\Model\ResourceModel\Report\Collection as ReportCollection;
/**
 * Report grid.
 * @category Mavgento
 * @package  Mavgento_Custombanner
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Mavgento\Custombanner\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'Mavgento\Custombanner\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
