...
namespace Mavgento\Custombanner\Block\Adminhtml\Banner\Edit\Tab;
...
class Banner extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Mavgento\Custombanner\Model\Banner
     */
    protected $_banner;
    ...
    public function __construct(
        ...
        \Mavgento\Custombanner\Model\Banner $banner,
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Mavgento\Custombanner\Block\Adminhtml\Form\Renderer\Fieldset\Element',
    ...
    protected function _prepareForm()
    {
        ...
        $elements['choose_type'] = $fieldset->addField(
            'choose_type',
            'select',
            [
                'title' => __('Choose url type'),
                'label' => __('Choose url type'),
                'name' => 'choose_type',
                'values' => $model->getUrlTypes()
            ]
        );

        $elements['product_url'] = $fieldset->addField(
            'product_url',
            'select',
            [
                ...
                'name' => 'product_url',
                'values' => $model->getUrlProducts(),
                'disabled' => true,
            ]
        );

        $elements['category_url'] = $fieldset->addField(
            'category_url',
            'select',
            [
...
//            $datetime = new \DateTime($dataObj->getData('end_time'));
        ...
        $elements['target'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Mavgento\Custombanner\Model\Banner::BANNER_TARGET_SELF,
                        'label' => __('New Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Mavgento\Custombanner\Model\Banner::BANNER_TARGET_PARENT,
                        'label' => __('Parent Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Mavgento\Custombanner\Model\Banner::BANNER_TARGET_BLANK,
