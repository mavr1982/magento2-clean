...
namespace Mavgento\Custombanner\Block\Adminhtml\Slider\Edit\Tab;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * [$_custombannerHelper description].
     *
    ...
    protected function _prepareForm()
    {
        ...
        $previewUrl = $this->_custombannerHelper->getBackendUrl('*/*/preview', ['_current' => false]);
        $fieldMaps['style_slide'] = $fieldset->addField(
            ...
            [
                ...
                'name' => 'style_slide',
                'values' => $this->_custombannerHelper->getStyleSlider(),
        ...
        $fieldMaps['sort_type'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Mavgento\Custombanner\Model\Slider::SORT_TYPE_RANDOM,
                        'label' => __('Random'),
                    ],
                    [
                        'value' => \Mavgento\Custombanner\Model\Slider::SORT_TYPE_ORDERLY,
                        'label' => __('Orderly'),
                    ],
                ],
            ]
        ...
        $fieldMaps['animationB'] = $fieldset->addField(
            ...
            [
                ...
                'name' => 'animationB',
                'values' => $this->_custombannerHelper->getAnimationB(),
            ]
        );
        ...
        $fieldMaps['animationA'] = $fieldset->addField(
            ...
            [
                'label' => __('Animation Effect'),
                'name' => 'animationA',
                'values' => $this->_custombannerHelper->getAnimationA(),
            ]
        );
        ...
        $fieldMaps['note_color'] = $fieldset->addField(
            ...
            [
                ...
                'label' => __('Color'),
                'title' => __('Color'),
                'values' => $this->_custombannerHelper->getOptionColor(),
            ]
        );
        ...
        $positionImage = [];
        for ($i = 1; $i <= 5; ++$i) {
            $positionImage[] = $this->getViewFileUrl("Mavgento_Custombanner::images/position/custombanner-ex{$i}.png");
        }
        $fieldMaps['position'] = $fieldset->addField(
            ...
            [
                ...
                'label' => __('Position'),
                'title' => __('Position'),
                'values' => $this->_custombannerHelper->getBlockIdsToOptionsArray(),
        ...
        $fieldMaps['category_ids'] = $fieldset->addField(
            ...
            [
                'label' => __('Categories'),
                'name' => 'category_ids',
                'values' => $this->_custombannerHelper->getCategoriesArray(),
            ]
        );
