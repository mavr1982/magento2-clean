...
class Banners extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Mavgento\Custombanner\Model\ResourceModel\Banner\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer' => 'Mavgento\Custombanner\Block\Adminhtml\Banner\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'title',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Mavgento\Custombanner\Block\Adminhtml\Slider\Edit\Tab\Helper\Renderer\EditBanner',
            ]
        );
