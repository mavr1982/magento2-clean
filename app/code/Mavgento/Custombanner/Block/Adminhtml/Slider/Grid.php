...
namespace Mavgento\Custombanner\Block\Adminhtml\Slider;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'options' => $this->_custombannerHelper->getAvailablePositions(),
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'width' => '50px',
                'type' => 'options',
                'options' => $this->_custombannerHelper->getSliderModeAvailable(),
            ]
        );
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                'label' => __('Delete'),
                'url' => $this->getUrl('custombanneradmin/*/massDelete'),
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                ...
                'url' => $this->getUrl('custombanneradmin/*/massStatus', ['_current' => true]),
                'additional' => [
                    'visibility' => [
                        'name' => 'status',
                        'type' => 'select',
