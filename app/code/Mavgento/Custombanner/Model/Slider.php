...
{
    const XML_CONFIG_BANNERSLIDER = 'custombanner/general/enable_frontend';
     ...
     * @param \Mavgento\Custombanner\Model\ResourceModel\Slider                   $resource
     * @param \Mavgento\Custombanner\Model\ResourceModel\Slider\Collection        $resourceCollection
     */
    public function __construct(
        \Magento\Framework\Model\Context $context,
        \Magento\Framework\Registry $registry,
        \Mavgento\Custombanner\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
        \Mavgento\Custombanner\Model\ResourceModel\Slider $resource,
        \Mavgento\Custombanner\Model\ResourceModel\Slider\Collection $resourceCollection
    ) {
        parent::__construct(
            $context,
            $registry,
