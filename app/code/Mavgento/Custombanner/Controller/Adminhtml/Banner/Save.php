 ...
 */
class Save extends \Mavgento\Custombanner\Controller\Adminhtml\Banner
{
    /**
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\Mavgento\Custombanner\Model\Banner::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \Mavgento\Custombanner\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
